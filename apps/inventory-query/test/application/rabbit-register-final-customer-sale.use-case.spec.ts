...
import { RabbitRegisterFinalCustomerSaleUseCase } from '../../src/application';
import {
  BranchTypeOrmRepository,
  SaleTypeOrmRepository,
} from '../../src/infrastructure';

describe('Rabbit Final Customer Sale Use Case', () => {
  let useCase: RabbitRegisterFinalCustomerSaleUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<RabbitRegisterFinalCustomerSaleUseCase>(
